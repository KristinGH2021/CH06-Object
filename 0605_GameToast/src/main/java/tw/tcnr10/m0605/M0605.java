    ...
    private void music(int i) {
        ...
        switch (i){
            case 1:  //贏
                ...
                f000.setTextColor(Color.GREEN);
                mediaWin.start();
                Toast.makeText(getApplicationContext(),getString(R.string.m0605_f001), Toast.LENGTH_SHORT).show();
                break;
            case 2:  //平
                answer=getString(R.string.m0605_f000)+getString(R.string.m0605_f003); //平手
                f000.setTextColor(Color.YELLOW);
                mediaDraw.start();
                Toast.makeText(getApplicationContext(),getString(R.string.m0605_f003), Toast.LENGTH_SHORT).show();
                break;
            case 3:  //輸
                answer=getString(R.string.m0605_f000)+getString(R.string.m0605_f002);  //輸
                f000.setTextColor(Color.RED);
                mediaLose.start();
                Toast.makeText(getApplicationContext(),getString(R.string.m0605_f002), Toast.LENGTH_SHORT).show();
                break;
            case 4:  //結束程式
